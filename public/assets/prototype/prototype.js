...
(function() {
  $(function() {
    var empty;
    $("body").on("click", ".res-issue, .res-news-post, .res-user", function() {
      $(".res-issue, .res-news-post, .res-user").removeClass("active");
      return $(this).toggleClass("active");
    });
    $("body").on("click", "#add-doc", function() {
      return $("#new-doc-panel").slideDown('fast');
    });
    $("body").on("click", "#cancel-add-doc, #submit-add-doc", function() {
      return $("#new-doc-panel").slideUp('fast');
    });
    $("body").on("click", ".console-search-result-item", function() {
      var div, html, panel, subject;
      ...
      if (!$(this).hasClass("doc")) {
        ...
        return $(".console-viewport").find(".title").val(subject);
      }
    });
    $("body").on("click", "#doc-filters .categories .category, #doc-filters ul li a", function() {
    ...
    $("body").on("click", "#nav li a", function() {
      ...
      return $("#doc-filters .categories .category.active").each(function() {
        return $("#list-docs").addClass($(this).data("filtertext"));
      });
    });
    $("body").on("click", "#main-nav li a", function() {
      var div, html, panel, resource;
    ...
    $("body").on("click", ".cancel", function() {
      ...
      div = "#empty" + panel;
      html = $(div).html();
      return $(".console-viewport").html(html);
    });
    $("body").on("click", ".action-pane .btn, #add-item", function() {
      return $(".console-search-result-item").removeClass("active");
    });
    $("#nav .property-settings").click(function() {
      alert("Settings for " + $(this).parents("a").text());
      return false;
    });
    empty = $(".console-viewport").html();
    $("body").on("change", "#user_role", function() {
      if ($(this).val() === "Manager") {
        $("#manager_permissions").show();
        return $("#resident_permissions").hide();
      } else {
        $("#resident_permissions").show();
        return $("#manager_permissions").hide();
      }
    });
    $("body").on("click", ".action-pane .btn, #add-item", function() {
      var div, html, panel;
    ...
    return $("body").on("click", ".navbar-collapse.in li a", function() {
