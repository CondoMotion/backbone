...
(function() {
  (function(Backbone) {
    ...
    return methods = {
      ...
      complete: function() {
        return this.trigger("sync:complete", this);
      }
    };
  })(Backbone);
...
(function() {
  (function(Marionette) {
    return _.extend(Marionette.Renderer, {
      lookups: ["admin/apps/", "admin/components/"],
      render: function(template, data) {
        var path;
...
(function() {
  this.Cmo = (function(Backbone, Marionette) {
    var App;
    App = new Marionette.Application;
    App.on("initialize:before", function(options) {
      this.currentUser = App.request("set:current:user", options.currentUser);
      return this.currentCompany = App.request("set:current:company", options.currentCompany);
    });
    App.addRegions({
    ...
    App.addInitializer(function() {
      return App.module("MenuApp").start();
    });
    ...
    App.reqres.setHandler("get:current:company", function() {
  ...
  subscription = {
    ...
    handleStripeResponse: function(status, response) {
      ...
      if (status === 200) {
        ...
        return $('.card-form').trigger('submit.rails');
      } else {
        ...
        return $('.card-form input[type=submit]').attr('disabled', false).val('Update');
      }
    }
  };
...
(function() {
  $(function() {
    ...
    return $("body").on('submit', '.edit_admin_user, .edit_subscription', function() {
      $(this).children('.loading').removeClass('hide');
      return $(this).children('input[type=submit]').attr('disabled', true).val("Updating...");
    });
  });
...
(function() {
  ...
  this.Cmo.module("Controllers", function(Controllers, App, Backbone, Marionette, $, _) {
...
(function() {
  ...
  this.Cmo.module("Views", function(Views, App, Backbone, Marionette, $, _) {
    var _ref;
  ...
  this.Cmo.module("Views", function(Views, App, Backbone, Marionette, $, _) {
    ...
    return _.extend(Marionette.View.prototype, {
      ...
      remove: function() {
        ...
        if (((_ref = this.model) != null ? typeof _ref.isDestroyed === "function" ? _ref.isDestroyed() : void 0 : void 0) && this.opacity === "true") {
      ...
      templateHelpers: function() {
        return {
          ...
          currentCompany: App.request("get:current:company").toJSON(),
...
(function() {
  this.Cmo.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
...
(function() {
  ...
  this.Cmo.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    var API, _ref, _ref1;
    Entities.Company = (function(_super) {
    ...
    Entities.CompaniesCollection = (function(_super) {
      __extends(CompaniesCollection, _super);

      function CompaniesCollection() {
        _ref1 = CompaniesCollection.__super__.constructor.apply(this, arguments);
        return _ref1;
      }

      CompaniesCollection.prototype.model = Entities.Company;

      return CompaniesCollection;

    })(Entities.Collection);
    API = {
      setCurrentCompany: function(currentCompany) {
        return new Entities.Company(currentCompany);
      }
    };
    return App.reqres.setHandler("set:current:company", function(currentCompany) {
      return API.setCurrentCompany(currentCompany);
    });
  });
...
(function() {
  ...
  this.Cmo.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    ...
    Entities.MenuCollection = (function(_super) {
      ...
      MenuCollection.prototype.model = Entities.Menu;
    ...
    API = {
      getMenus: function() {
        return new Entities.MenuCollection([
          {
            name: "Issues",
            url: "/issues"
          }, {
    ...
    return App.reqres.setHandler("menu:entities", function() {
      return API.getMenus();
    });
  });
...
(function() {
  ...
  this.Cmo.module("Entities", function(Entities, App, Backbone, Marionette, $, _) {
    var API, _ref, _ref1;
    Entities.Property = (function(_super) {
      ...
      Property.prototype.urlRoot = function() {
        return Routes.api_v1_properties_path();
      };

      return Property;

    })(Entities.Model);
    Entities.PropertyCollection = (function(_super) {
      __extends(PropertyCollection, _super);

      function PropertyCollection() {
        _ref1 = PropertyCollection.__super__.constructor.apply(this, arguments);
        return _ref1;
      }

      PropertyCollection.prototype.model = Entities.Property;

      PropertyCollection.prototype.url = function() {
        return Routes.api_v1_properties_path();
      };
    ...
    App.reqres.setHandler("property:entities", function() {
      return API.getProperties();
    });
    App.reqres.setHandler("property:entity", function(id) {
      return API.getProperty(id);
    });
    return App.reqres.setHandler("new:property:entity", function() {
      return API.newProperty();
    });
  });
...
(function() {
  ...
  this.Cmo.module("Components.Form", function(Form, App, Backbone, Marionette, $, _) {
    var _ref;
    Form.Controller = (function(_super) {
      ...
      Controller.prototype.onClose = function() {
        ...
        return this.formLayout.addOpacityWrapper(false);
      };
  ...
  this.Cmo.module("Components.Form", function(Form, App, Backbone, Marionette, $, _) {
    ...
    return Form.FormWrapper = (function(_super) {
      ...
      FormWrapper.prototype.removeErrors = function() {
        return this.$('.has-error').removeClass('has-error').find(".help-block").remove();
      };
...
(function() {
  ...
  window.JST['admin/components/form/templates/form'] = function(context) {
    return (function() {
      var $c, $e, $o, button, _i, _len, _ref;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      console.info("form options", this);
      $o.push("<div id='form-content-region'></div>");
      if (this.footer) {
        $o.push("<footer>");
        if (this.buttons) {
          $o.push("  <div id='buttons'>");
          _ref = this.buttons;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            button = _ref[_i];
            $o.push("    <button class='" + ($e($c(button.className))) + "' data-form-button='" + ($e($c(button.type))) + "' type='" + ($e($c(button.buttonType))) + "'>" + ($e($c(button.text))) + "</button>");
          }
...
(function() {
  ...
  this.Cmo.module("MenuApp.List", function(List, App, Backbone, Marionette, $, _) {
    var _ref;
    return List.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function() {
        ...
        listView = this.getListView(links);
        this.listenTo(listView, "signOut:button:clicked", function() {
          return alert("Hello");
        });
        return this.show(listView);
      };

      Controller.prototype.getListView = function(links) {
...
(function() {
  ...
  this.Cmo.module("MenuApp.List", function(List, App, Backbone, Marionette, $, _) {
    ...
    List.Menu = (function(_super) {
      ...
      Menu.prototype.template = "menu/list/templates/menu";
    ...
    return List.Menus = (function(_super) {
      __extends(Menus, _super);

      function Menus() {
        _ref1 = Menus.__super__.constructor.apply(this, arguments);
        return _ref1;
      }

      Menus.prototype.template = "menu/list/templates/menus";

      Menus.prototype.itemView = List.Menu;

      Menus.prototype.itemViewContainer = "#links";
...
(function() {
  ...
  window.JST['admin/apps/menu/list/templates/menu'] = function(context) {
    return (function() {
      var $c, $o;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("" + $c(this.linkTo(this.name, this.url)));
...
(function() {
  ...
  window.JST['admin/apps/menu/list/templates/menus'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<nav class='navbar navbar-fixed-top navbar-inverse' role='navigation'>\n  <div class='navbar-header'>\n    <button class='navbar-toggle' data-target='.navbar-ex1-collapse' data-toggle='collapse' type='button'>\n      <span class='sr-only'>Toggle navigation</span>\n      <span class='icon-bar'></span>\n      <span class='icon-bar'></span>\n      <span class='icon-bar'></span>\n    </button>\n    <a class='navbar-brand' href='#'>" + ($e($c(this.currentCompany.name))) + "</a>\n  </div>\n  <div class='collapse navbar-collapse navbar-ex1-collapse'>\n    <ul class='nav navbar-nav side-nav' id='links'></ul>\n    <ul class='nav navbar-nav navbar-right navbar-user'>\n      <li class='dropdown user-dropdown'>\n        <a class='dropdown-toggle' data-toggle='dropdown' href='#'>\n          <i class='fa fa-user'></i>");
      $o.push("          " + $e($c(this.currentUser.name)));
      $o.push("          <b class='caret'></b>\n        </a>\n        <ul class='dropdown-menu'>\n          <li>\n            <a href='/admin/settings'>\n              <i class='fa fa-gear'></i>\n              Settings\n            </a>\n          </li>\n          <li class='divider'></li>\n          <li>\n            <a id='sign-out' href='/admin/sign_out' data-method='delete' rel='nofollow'>\n              <i class='fa fa-power-off'></i>\n              Log Out\n            </a>\n          </li>\n        </ul>\n      </li>\n    </ul>\n  </div>\n</nav>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  this.Cmo.module("MenuApp", function(MenuApp, App, Backbone, Marionette, $, _) {
    var API;
    this.startWithParent = false;
    API = {
      list: function() {
        return new MenuApp.List.Controller({
          region: App.menuRegion
        });
      }
    };
    return MenuApp.on("start", function() {
      return API.list();
    });
  });
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.Edit", function(Edit, App, Backbone, Marionette, $, _) {
    var _ref;
    return Edit.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        ...
        property = options.property, id = options.id;
        property || (property = App.request("property:entity", id));
        this.listenTo(property, "updated", function() {
          return App.vent.trigger("property:updated", property);
        });
        this.listenTo(property, "destroy", function() {
          return App.vent.trigger("property:destroyed");
        });
        return App.execute("when:fetched", property, function() {
          _this.layout = _this.getLayoutView(property);
          _this.listenTo(_this.layout, "show", function() {
            _this.titleRegion(property);
            return _this.formRegion(property);
          });
          return _this.show(_this.layout);
        });
      };

      Controller.prototype.titleRegion = function(property) {
        var titleView;
        titleView = this.getTitleView(property);
        return this.layout.titleRegion.show(titleView);
      };

      Controller.prototype.formRegion = function(property) {
        var editView, formView;
        editView = this.getEditView(property);
        this.listenTo(editView, "form:cancel", function() {
          return App.vent.trigger("edit:property:cancelled", property);
        });
        formView = App.request("form:wrapper", editView, {
          footer: true
        });
        return this.layout.formRegion.show(formView);
      };

      Controller.prototype.getLayoutView = function(property) {
        return new Edit.Layout({
          model: property
        });
      };

      Controller.prototype.getEditView = function(property) {
        return new Edit.Property({
          model: property
        });
      };

      Controller.prototype.getTitleView = function(property) {
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.Edit", function(Edit, App, Backbone, Marionette, $, _) {
    ...
    Edit.Layout = (function(_super) {
      ...
      Layout.prototype.template = "properties/edit/edit_layout";
    ...
    Edit.Title = (function(_super) {
      __extends(Title, _super);

      function Title() {
        _ref1 = Title.__super__.constructor.apply(this, arguments);
        return _ref1;
      }

      Title.prototype.template = "properties/edit/edit_title";
    ...
    return Edit.Property = (function(_super) {
      __extends(Property, _super);

      function Property() {
        _ref2 = Property.__super__.constructor.apply(this, arguments);
        return _ref2;
      }

      Property.prototype.template = "properties/edit/edit_property";
...
(function() {
  ...
  window.JST['admin/apps/properties/edit/templates/edit_layout'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div id='title-region'></div>\n<div id='form-region'></div>");
...
(function() {
  ...
  window.JST['admin/apps/properties/edit/templates/edit_property'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<div id='new-property'>\n  <div class='row'>\n    <div class='col-sm-12'>\n      <div class='form-group'>\n        <label class='control-label'>Name</label>\n        <input class='form-control' id='name' type='text' name='name' placeholder='Property Name' value='" + ($e($c(this.name))) + "'>\n      </div>\n      <div class='form-group'>\n        <label class='control-label'>Signup password</label>\n        <input class='form-control' id='signup_password' type='text' name='signup_password' placeholder='Signup Password' value='" + ($e($c(this.signup_password))) + "'>\n      </div>\n      <div class='form-group'>\n        <label class='control-label'>Subdomain</label>\n        <input class='form-control' id='subdomain_name' type='text' name='subdomain_attributes[name]' placeholder='Subdomain' value='" + ($e($c(this.subdomain))) + "'>\n      </div>\n    </div>\n  </div>\n</div>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['admin/apps/properties/edit/templates/edit_title'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      $o = [];
      $o.push("<h3>" + ($e($c("Edit " + this.name))) + "</h3>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '');
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.List", function(List, App, Backbone, Marionette, $, _) {
    var _ref;
    return List.Controller = (function(_super) {
      __extends(Controller, _super);
      ...
      Controller.prototype.initialize = function() {
        ...
        return App.execute("when:fetched", properties, function() {
          _this.layout = _this.getLayoutView();
          _this.listenTo(_this.layout, "close", _this.close);
          _this.listenTo(_this.layout, "show", function() {
            _this.propertiesRegion(properties);
      ...
      Controller.prototype.onClose = function() {
        return console.info("closing controller!");
      };

      Controller.prototype.panelRegion = function() {
        var panelView,
          _this = this;
        panelView = this.getPanelView();
        panelView.on("new:property:button:clicked", function() {
          return App.vent.trigger("new:property:button:clicked");
        });
        return this.layout.panelRegion.show(panelView);
      };

      Controller.prototype.propertiesRegion = function(properties) {
        var propertiesView;
        propertiesView = this.getPropertiesView(properties);
        this.listenTo(propertiesView, "childview:property:clicked", function(child, args) {
          return App.vent.trigger("property:clicked", args.model);
        });
        this.listenTo(propertiesView, "childview:delete:property:link:clicked", function(child, args) {
          var model;
          model = args.model;
        ...
        return this.layout.propertiesRegion.show(propertiesView);
      };
      ...
      Controller.prototype.getPropertiesView = function(properties) {
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.List", function(List, App, Backbone, Marionette, $, _) {
    ...
    List.Layout = (function(_super) {
      ...
      Layout.prototype.template = "properties/list/list_layout";
    ...
    List.Panel = (function(_super) {
      ...
      Panel.prototype.template = "properties/list/panel";
    ...
    List.Property = (function(_super) {
      ...
      Property.prototype.template = "properties/list/property";

      Property.prototype.tagName = "li";

      Property.prototype.className = "property";

      Property.prototype.opacity = "true";

      Property.prototype.events = {
        "click": function() {
          return this.trigger("property:clicked", this.model);
        }
      };

      Property.prototype.triggers = {
    ...
    List.Empty = (function(_super) {
      ...
      function Empty() {
        _ref3 = Empty.__super__.constructor.apply(this, arguments);
        return _ref3;
      }

      Empty.prototype.template = "properties/list/empty";
    ...
    return List.Properties = (function(_super) {
      __extends(Properties, _super);

      function Properties() {
        _ref4 = Properties.__super__.constructor.apply(this, arguments);
        return _ref4;
      }

      Properties.prototype.template = "properties/list/properties";

      Properties.prototype.itemView = List.Property;

      Properties.prototype.emptyView = List.Empty;

      Properties.prototype.itemViewContainer = "ul";
...
(function() {
  ...
  window.JST['admin/apps/properties/list/templates/empty'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("No properties!");
      return $o.join("\n");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['admin/apps/properties/list/templates/list_layout'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div class='well'>\n  <div id='panel-region'></div>\n</div>\n<div id='properties-region'></div>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['admin/apps/properties/list/templates/panel'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<h3 class='margin-0 pull-left' style='margin-top: 3px;'>Properties</h3>\n<a class='btn btn-success new-property pull-right' href='#'>New Property</a>\n<div class='clearfix'></div>\n<input class='form-control' type='search' style='border-radius: 30px; margin-top: 15px;'>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['admin/apps/properties/list/templates/properties'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<ul class='properties'></ul>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  window.JST['admin/apps/properties/list/templates/property'] = function(context) {
    return (function() {
      var $c, $e, $o;
      $e = window.HAML.escape;
      $c = window.HAML.cleanValue;
      ...
      $o.push("<div class='pull-right'>\n  <a class='delete-property btn btn-default btn-xs' href='#'>\n    <span class='glyphicon glyphicon-remove-sign'></span>\n    Delete\n  </a>\n</div>");
      return $o.join("\n").replace(/\s(\w+)='true'/mg, ' $1').replace(/\s(\w+)='false'/mg, '').replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.New", function(New, App, Backbone, Marionette, $, _) {
    var _ref;
    return New.Controller = (function(_super) {
      ...
      Controller.prototype.initialize = function(options) {
        var formView, newView, property,
          _this = this;
        property = App.request("new:property:entity");
        this.listenTo(property, "created", function() {
          return App.vent.trigger("property:created", property);
        });
        newView = this.getNewView(property);
        formView = App.request("form:wrapper", newView);
        this.listenTo(newView, "form:cancel", function() {
          return App.vent.trigger("create:property:cancelled", property);
        });
        return this.show(formView);
      };

      Controller.prototype.getNewView = function(property) {
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.New", function(New, App, Backbone, Marionette, $, _) {
    var _ref;
    return New.Property = (function(_super) {
      __extends(Property, _super);
      ...
      Property.prototype.template = "properties/new/new_property";

      Property.prototype.form = {
        buttons: {
          placement: 'pull-right'
        }
      };
...
(function() {
  ...
  window.JST['admin/apps/properties/new/templates/new_property'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div id='new-property'>\n  <h3>New Property</h3>\n  <div class='row'>\n    <div class='col-sm-12'>\n      <div class='form-group'>\n        <label class='control-label'>What's the property's name?</label>\n        <input class='form-control' id='name' type='text' name='name' placeholder='Property Name'>\n      </div>\n      <div class='form-group'>\n        <label class='control-label'>What's the property's signup password?</label>\n        <input class='form-control' id='signup_password' type='text' name='signup_password' placeholder='Signup Password'>\n      </div>\n      <div class='form-group'>\n        <label class='control-label'>What's the property's subdomain?</label>\n        <input class='form-control' id='subdomain_name' type='text' name='subdomain_attributes[name]' placeholder='Subdomain'>\n      </div>\n    </div>\n  </div>\n</div>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.Pane", function(Pane, App, Backbone, Marionette, $, _) {
    var _ref;
    return Pane.Controller = (function(_super) {
      __extends(Controller, _super);
      ...
      Controller.prototype.initialize = function(options) {
        var paneView,
          _this = this;
        paneView = this.getPaneView();
        paneView.on("new:property:button:clicked", function() {
          return App.vent.trigger("new:property:button:clicked");
        });
        return this.show(paneView);
      };

      Controller.prototype.getPaneView = function() {
        return new Pane.Show;
      };
...
(function() {
  ...
  this.Cmo.module("PropertiesApp.Pane", function(Pane, App, Backbone, Marionette, $, _) {
    var _ref;
    return Pane.Show = (function(_super) {
      ...
      Show.prototype.template = "properties/pane/show";

      Show.prototype.triggers = {
        "click .new-property": "new:property:button:clicked"
      };
...
(function() {
  ...
  window.JST['admin/apps/properties/pane/templates/show'] = function(context) {
    return (function() {
      var $o;
      $o = [];
      $o.push("<div class='center well'>\n  <a class='btn btn-primary new-property' href='#'>New Property</a>\n</div>");
      return $o.join("\n").replace(/\s(?:id|class)=(['"])(\1)/mg, "");
    }).call(window.HAML.context(context));
  };
...
(function() {
  ...
  this.Cmo.module("PropertiesApp", function(PropertiesApp, App, Backbone, Marionette, $, _) {
    var API, _ref;
    PropertiesApp.Router = (function(_super) {
    ...
    API = {
      list: function() {
        return new PropertiesApp.List.Controller;
      },
      pane: function() {
        return new PropertiesApp.Pane.Controller({
          region: App.paneRegion
        });
      },
      "new": function() {
        return new PropertiesApp.New.Controller({
          region: App.paneRegion
        });
      },
      edit: function(id, property) {
        return new PropertiesApp.Edit.Controller({
          region: App.paneRegion,
          id: id,
          property: property
        });
    ...
    App.vent.on("new:property:button:clicked", function() {
      App.navigate("properties/new");
      return API["new"]();
    });
    App.vent.on("property:clicked", function(property) {
      App.navigate("properties/" + property.id + "/edit");
      return API.edit(property.id, property);
    });
    App.vent.on("edit:property:cancelled create:property:cancelled property:destroyed ", function() {
      App.navigate("properties");
      return API.pane();
    });
    App.vent.on("property:created property:updated", function(property) {
      App.navigate("properties");
      return API.paneList();
    });
    return App.addInitializer(function() {
      return new PropertiesApp.Router({
        controller: API
      });
    });
  });
